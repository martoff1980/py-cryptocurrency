...
def test_should_buy_when_prediction_more_than_5_percent(
    ...
    monkeypatch.setattr(main, "get_exchange_rate_prediction", lambda: 106)
...
def test_should_sell_when_prediction_less_than_5_percent(
    ...
    monkeypatch.setattr(main, "get_exchange_rate_prediction", lambda: 94)
...
def test_should_do_nothing_when_change_within_5_percent(
    ...
    monkeypatch.setattr(main, "get_exchange_rate_prediction", lambda: 104)
...
def test_should_do_nothing_when_change_exactly_5_percent(
    ...
    monkeypatch.setattr(main, "get_exchange_rate_prediction", lambda: 105)
